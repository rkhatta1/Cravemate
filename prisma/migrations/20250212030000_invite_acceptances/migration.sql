...
CREATE TABLE "Message" (
    ...
    "isYelpResponse" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE UNIQUE INDEX "InviteAcceptance_groupId_userId_key" ON "InviteAcceptance"("groupId", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "InviteAcceptance_inviteMessageId_userId_key" ON "InviteAcceptance"("inviteMessageId", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "Leaderboard_dishSlug_locationSlug_key" ON "Leaderboard"("dishSlug", "locationSlug");
...
-- AddForeignKey
ALTER TABLE "InviteAcceptance" ADD CONSTRAINT "InviteAcceptance_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "InviteAcceptance" ADD CONSTRAINT "InviteAcceptance_inviteMessageId_fkey" FOREIGN KEY ("inviteMessageId") REFERENCES "Message"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Leaderboard" ADD CONSTRAINT "Leaderboard_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
