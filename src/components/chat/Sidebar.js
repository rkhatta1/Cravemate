        ...
        <div className="px-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-full border border-gray-200 px-9 py-2 text-sm focus:border-yelp-red focus:ring-1 focus:ring-yelp-red/60"
            />
          </div>
        </div>
